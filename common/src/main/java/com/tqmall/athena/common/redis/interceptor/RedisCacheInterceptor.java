package com.tqmall.athena.common.redis.interceptor;

import com.tqmall.athena.common.redis.RedisClientTemplate;
import com.tqmall.athena.common.redis.annotation.RedisCache;
import com.tqmall.athena.common.redis.annotation.RedisKeyParam;
...
public class RedisCacheInterceptor implements MethodInterceptor {
    ...
    private Object parseCache(Method method, String redisStr){
        ...
        return JsonUtil.jsonStrToObject(redisStr, rType);
    }
